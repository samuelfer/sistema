...
class OcorrenciamoradorResource extends AbstractResourceListener
{
    private $repository;
    ...
    public function create($data)
    {
        ...
        $dataOcorrenciamorador = $hydrator->extract($data);
        $result = $this->repository->create($dataOcorrenciamorador);
    ...
    public function fetch($id_ocorrencia_morador)
    {
        return $this->repository->find($id_ocorrencia_morador);
    }
     ...
     * @return ApiProblem|mixed
     */
    //Retorna uma colecao de ocorrencias
