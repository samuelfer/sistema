...
class DocumentofuncionarioResource extends AbstractResourceListener
{
    private $repository;
    
    public function __construct(DocumentofuncionarioRepository $repository)
    { 
    ...
    public function create($data)
    {
        ...
        $dataDocumentofuncionario = $hydrator->extract($data);
        $result = $this->repository->create($dataDocumentofuncionario);
    ...
    public function fetch($id_funcionarios)
    {
        return $this->repository->find($id_funcionarios);
    }
