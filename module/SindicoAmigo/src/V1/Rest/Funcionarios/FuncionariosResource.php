...
class FuncionariosResource extends AbstractResourceListener
{
    private $repository;

    /**
     * FuncionariosResource constructor.
     * @param FuncionariosRepository $repository
     */
    ...
    public function create($data)
    {
        ...
        $dataFuncionario = $hydrator->extract($data);
        $result = $this->repository->create($dataFuncionario);
