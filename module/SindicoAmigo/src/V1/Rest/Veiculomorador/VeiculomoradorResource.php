...
class VeiculomoradorResource extends AbstractResourceListener
{
    ...
    public function create($data)
    {
       ...
       $dataVeiculo = $hydrator->extract($data);
       $result = $this->repository->create($dataVeiculo);
     ...
     * Fetch a resource
     *
     * @param  mixed $id_veiculo_morador
     * @return ApiProblem|mixed
     */
    //Retorna um registro pelo id
    public function fetch($id_veiculo_morador)
    {
        return $this->repository->find($id_veiculo_morador);
    }
     ...
     * @return ApiProblem|mixed
     */
    //Retorna uma colecao de veiculos
