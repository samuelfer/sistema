...
class RestricaoResource extends AbstractResourceListener
{
    ...
    public function create($data)
    {
        ...
        $dataRestricao = $hydrator->extract($data);
        $result = $this->repository->create($dataRestricao);
        print_r($data);
     ...
     * @return ApiProblem|mixed
     */
    //Retorna a restricao pelo id
    public function fetch($id_restricao)
    {
        return $this->repository->find($id_restricao);
    }
