...
class AgendacompromissoResource extends AbstractResourceListener
{
    private $repository;
    ...
    public function create($data)
    {
        ...
        $dataAgenda = $hydrator->extract($data);
        $result = $this->repository->create($dataAgenda);
    ...
    public function fetch($id_agenda)
    {
        return $this->repository->find($id_agenda);
    }
