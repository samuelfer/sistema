...
class UploadResource extends AbstractResourceListener
{
    ...
    public function create($data)
    {
        ...
        $dataUpload = $hydrator->extract($data);
        $result = $this->repository->create($dataUpload);
    ...
    public function fetch($id_uplaod)
    {
        return $this->repository->find($id_uplaod);
    }
     ...
     * @return ApiProblem|mixed
     */
    //Retorna uma colecao de uplaods
