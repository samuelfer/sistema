...
class AvisoResource extends AbstractResourceListener
{
    private $repository;
    ...
    public function create($data)
    {
        ...
        $dataAviso = $hydrator->extract($data);
        $result = $this->repository->create($dataAviso);
    ...
    public function fetch($id_aviso)
    {
        return $this->repository->find($id_aviso);
    }
