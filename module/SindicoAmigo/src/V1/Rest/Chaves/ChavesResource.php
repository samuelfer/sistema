...
class ChavesResource extends AbstractResourceListener
{
    private $repository;
    ...
    public function create($data)
    {
        ...
        $dataChaves = $hydrator->extract($data);
        $result = $this->repository->create($dataChaves);
     ...
     * Fetch a resource
     *
     * @param  mixed $id_chaves
     * @return ApiProblem|mixed
     */
    //Retorna um registro pelo id
    public function fetch($id_chaves)
    {
        return $this->repository->find($id_chaves);
    }
