...
class LeituragasResource extends AbstractResourceListener
{
    private $repository;
    
    public function __construct(LeituragasRepository $repository)
    {
    ...
    public function create($data)
    {
        ...
        $dataLeituragas = $hydrator->extract($data);
        $result = $this->repository->create($dataLeituragas);
     ...
     * Fetch a resource
     *
     * @param  mixed $id_leitura
     * @return ApiProblem|mixed
     */
    //Retorna um registro pelo id
    public function fetch($id_leitura)
    {
        return $this->repository->find($id_leitura);
    }
