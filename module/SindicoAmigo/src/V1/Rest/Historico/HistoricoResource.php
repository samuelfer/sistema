...
class HistoricoResource extends AbstractResourceListener
{
    private $repository;
    ...
    public function create($data)
    {
        ...
        $dataHistorico = $hydrator->extract($data);
        $result = $this->repository->create($dataHistorico);
    ...
    public function fetch($id_historico)
    {
        return $this->repository->find($id_historico);
    }
     ...
     * @return ApiProblem|mixed
     */
    //Retorna uma colecao de historicos
