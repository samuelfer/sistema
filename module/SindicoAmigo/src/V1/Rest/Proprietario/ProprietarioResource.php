...
class ProprietarioResource extends AbstractResourceListener
{
    private $repository;
    
    public function __construct(ProprietarioRepository $repository)
    {
    ...
    public function create($data)
    {
        ...
        $dataProprietario = $hydrator->extract($data);
        $result = $this->repository->create($dataProprietario);
        print_r($data);
     ...
     * @return ApiProblem|mixed
     */
    //Retorna um proprietario pelo id
    public function fetch($id_proprietario)
    {
        return $this->repository->find($id_proprietario);
