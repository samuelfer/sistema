...
class CorrespondenciaRepository
{
    ...
    public function find($id_correspondencia){
        $resultSet = $this->tableGateway->select(['id_correspondencia' => (int)$id_correspondencia]);
    ...
    public function findAll()
    {
        ...
        return new CorrespondenciaCollection($paginatorAdapter);
    }
    ...
    public function create($data)
    {
        try {
            ...
            $idCorrespondencia = $this->tableGateway->getLastInsertValue();
     ...
     public function update($id, $data)
    {
       ...
       //return $this->find($id);
        ...
        try {
            $this->tableGateway->getAdapter()->getDriver()->getConnection()->beginTransaction();
            $this->tableGateway->update((array)$data, ["id_correspondencia"=>(int)$id]);
            $this->tableGateway->getAdapter()->getDriver()->getConnection()->commit();
     ...
     public function delete($id)
    {
        ...
        $this->tableGateway->delete(['id_correspondencia'=>(int)$id]);
        return true;
    }
