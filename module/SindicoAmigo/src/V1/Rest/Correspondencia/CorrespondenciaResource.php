...
class CorrespondenciaResource extends AbstractResourceListener
{
    private $repository;
    ...
    public function create($data)
    {
        ...
        $dataCorrespondencia = $hydrator->extract($data);
        $result = $this->repository->create($dataCorrespondencia);
    ...
    public function fetch($id_correspondencia)
    {
        return $this->repository->find($id_correspondencia);
    }
