...
class ContacorrenteResource extends AbstractResourceListener
{
    private $repository;
    
    public function __construct(ContacorrenteRepository $repository)
    {        
    ...
    public function create($data)
    {
       ...
       $dataContacorrente = $hydrator->extract($data);
       $result = $this->repository->create($dataContacorrente);
    ...
    public function fetch($nu_conta)
    {
        return $this->repository->find($nu_conta);
    }
