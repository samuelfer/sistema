...
class ImovelResource extends AbstractResourceListener
{
    private $repository;
    ...
    public function create($data)
    {
        ...
        $dataImovel = $hydrator->extract($data);
        $result = $this->repository->create($dataImovel);
    ...
    public function fetch($id_numero_imovel)
    {
        return $this->repository->find($id_numero_imovel);
    }
     ...
     * @return ApiProblem|mixed
     */
    //Retorna uma colecao de imoveis
