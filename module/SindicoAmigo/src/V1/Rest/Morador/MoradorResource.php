...
class MoradorResource extends AbstractResourceListener
{
    private $repository;
    
    public function __construct(MoradorRepository $repository)
    { 
    ...
    public function create($data)
    {
        ...
        $dataMorador = $hydrator->extract($data);
        $result = $this->repository->create($dataMorador);
