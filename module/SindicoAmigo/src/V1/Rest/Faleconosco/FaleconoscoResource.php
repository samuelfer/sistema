...
class FaleconoscoResource extends AbstractResourceListener
{
    private $repository;
    ...
    public function create($data)
    {
        ...
        $dataFaleconosco = $hydrator->extract($data);
        $result = $this->repository->create($dataFaleconosco);
     ...
     * @return ApiProblem|mixed
     */
    //Retoena um regidtro pelo id
    public function fetch($id_fale_conosco)
    {
        return $this->repository->find($id_fale_conosco);
    }
     ...
     * @return ApiProblem|mixed
     */
    //Retorna uma colecao de faleconosco
