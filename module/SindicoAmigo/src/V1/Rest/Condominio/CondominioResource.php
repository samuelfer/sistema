...
class CondominioResource extends AbstractResourceListener
{
    ...
    public function create($data)
    {
        ...
        $dataCondominio = $hydrator->extract($data);
        $result = $this->repository->create($dataCondominio);
     ...
     * @return ApiProblem|mixed
     */
    public function fetch($id_condominio)
    {
        return $this->repository->find($id_condominio);
    }
