...
class PrestadorservicoResource extends AbstractResourceListener
{
    private $repository;
    ...
    public function create($data)
    {
        ...
        $dataPrestador = $hydrator->extract($data);
        $result = $this->repository->create($dataPrestador);
        print_r($data);
     ...
     * @return ApiProblem|mixed
     */
    //Retorna um prestador pelo id
    public function fetch($id_prestador_servico)
    {
        return $this->repository->find($id_prestador_servico);
    }
     ...
     * @return ApiProblem|mixed
     */
    //Retorna uma colecao de prestadores
