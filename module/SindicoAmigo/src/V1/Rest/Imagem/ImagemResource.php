...
class ImagemResource extends AbstractResourceListener
{
    private $repository;
    ...
    public function create($data)
    {
        ...
        $dataImagem = $hydrator->extract($data);
        $result = $this->repository->create($dataImagem);
    ...
    public function fetch($id_imagem)
    {
        return $this->repository->find($id_imagem);
    }
