...
class MultaveiculoResource extends AbstractResourceListener
{
    ...
    public function __construct(MultaveiculoRepository $repository)
    {
     ...
     * @return ApiProblem|mixed
     */
    public function fetch($id_multa_veiculo)
    {
       return $this->repository->find($id_multa_veiculo);
    }
