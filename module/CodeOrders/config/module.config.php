...
return [
    ...
    'zf-hal' => [
        'metadata_map' => [
            ...
            'CodeOrders\\V1\\Rest\\Ordes\\OrdesCollection' => [
                'entity_identifier_name' => 'id',
                'route_name' => 'code-orders.rest.orders',
                'route_identifier_name' => 'orders_id',
                'is_collection' => true,
    ...
    'zf-apigility' => [
        'db-connected' => [
            'CodeOrders\\V1\\Rest\\Ptypes\\PtypesResource' => [
                'adapter_name' => 'DbAdapterCode',
                'table_name' => 'ptypes',
                'hydrator_name' => \Zend\Hydrator\ArraySerializable::class,
                'controller_service_name' => 'CodeOrders\\V1\\Rest\\Ptypes\\Controller',
                'entity_identifier_name' => 'id',
            ],
            'CodeOrders\\V1\\Rest\\Products\\ProductsResource' => [
                'adapter_name' => 'DbAdapterCode',
                'table_name' => 'products',
                'hydrator_name' => \Zend\Hydrator\ArraySerializable::class,
                'controller_service_name' => 'CodeOrders\\V1\\Rest\\Products\\Controller',
                'entity_identifier_name' => 'id',
            ],
        ],
    ],
    ...
    'input_filter_specs' => [
        'CodeOrders\\V1\\Rest\\Ptypes\\Validator' => [
            0 => [
                ...
                'field_type' => 'Texto',
                'error_message' => 'Nome do campo inválido!',
            ],
        ],
        'CodeOrders\\V1\\Rest\\Products\\Validator' => [
            0 => [
                'name' => 'name',
                'required' => true,
                'filters' => [
    ...
    'service_manager' => [
        'factories' => [
            ...
            \CodeOrders\V1\Rest\Orders\OrderItemTableGateway::class => \CodeOrders\V1\Rest\Orders\OrderItemTableGatewayFactory::class,
